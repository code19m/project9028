    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('director', 'Director'), ('warehouseman', 'Warehouseman'), ('salesman', 'Salesman'), ('financier', 'Financier')], max_length=12), size=None)),
